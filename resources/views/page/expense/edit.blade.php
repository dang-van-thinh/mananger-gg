                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" id="amount" name="amount" class="form-control"
                                    value="{{ $expense->amount }}" placeholder="Nhập Số tiền chi">
                            </div>
                            @error('amount')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="title" name="title" class="form-control"
                                    value="{{ $expense->title }}" placeholder="Nhập Tiêu đề">
                            </div>
                            @error('title')
                                <p class="text-danger badge">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="paid_to" name="paid_to" class="form-control"
                                    value="{{ $expense->paid_to }}" placeholder="Nhập tên người nhận">
                            </div>
                            @error('paid_to')
                                <p class="text-danger badge">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select id="payment_method" name="payment_method" class="form-control">
                                    <option value="Chuyển khoản" @if ($expense->payment_method == 'Chuyển khoản') selected @endif>
                                        Chuyển khoản
                                    </option>
                                    <option value="Tiền mặt" @if ($expense->payment_method == 'Tiền mặt') selected @endif>
                                        Tiền mặt
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <textarea id="note" name="note" class="form-control" placeholder="Nhập ghi chú" cols="30" rows="5">{{ $expense->note }}</textarea>
                            </div>
                            @error('note')
                                <p class="text-danger badge">{{ $message }}</p>
                            @enderror
